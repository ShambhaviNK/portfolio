...
// Skill data (icons from react-icons devicons set)
const SKILLS = [
  // Frontend
  ...
  { icon: <SiPostman />, name: "REST APIs", category: "Backend" },
  ...
  { icon: <SiJasmine />, name: "Jasmine", category: "Tools" },
  ...
  { icon: <SiCanva />, name: "Canva", category: "Tools" },
  { icon: <SiAdobephotoshop />, name: "Photoshop", category: "Tools" },
  { icon: <SiTypeform />, name: "Typeform", category: "Tools" },
  ...
  { icon: <SiR />, name: "R", category: "Languages" },
  // Specializations (keep emojis where no dedicated icon)
